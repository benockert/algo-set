...
// loop over word and compare each letter in word to answer, return array of values i.e. [0,1,1,0,2]
...
export const main = Reach.App(() => {
  ...
  while (result == CONTINUE) {
    ...
    //interact.seeGuessResult(result);
    continue;
  }
